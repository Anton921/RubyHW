...
array.each_with_index { |num, _i| puts num.to_f / 10 }
puts '---------------------------------------------------'
...
a1 = %w[a b c d e f g h i j k l m n o p q r s t u v w x y z]
a2 = []
array.each_with_index { |num, _i| a2.push(a1[num - 1]) if num >= 1 && num <= 26 }
puts a2
puts '---------------------------------------------------'
...
a1 = array.min
b1 = array.max
array[array.index(array.min)] = b1
array[array.index(array.max)] = a1
p array
puts '---------------------------------------------------'
